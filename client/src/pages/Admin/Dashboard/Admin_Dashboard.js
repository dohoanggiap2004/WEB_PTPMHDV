            ...
            <div className="lg:ml-72 mt-16 md:mt-0">
                <div className="px-8 border-2 border-gray-200 border-dashed rounded-2xl dark:border-gray-700">
                    <div className="grid md:grid-cols-3 grid-cols-1 gap-4 mb-4">
                        ...
                        <div
                            ...
                            <div className="mx-5">
                                ...
                                <div className="text-gray-500 font-semibold">Laptops còn hàng</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={'grid grid-rows-3 grid-cols-3 gap-4 place-items-center mb-4'}>
                        {/*chart revenue*/}
                        <div
                            className="flex items-center justify-center h-[330px] w-full rounded-2xl shadow-md bg-white dark:bg-gray-800 col-span-2 row-span-3 place-items-center">
                            <LineChart/>
                        </div>
                    ...
                    <div className="gap-4 mb-4 !h-full bg-white rounded-2xl shadow-md pb-6">
                        ...
                        <div className="relative overflow-x-auto">
                            <table className="w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tr>
                                    <th scope="col" className="px-6 py-3">Tên laptop</th>
                                    ...
                                    <th scope="col" className="px-6 py-3">Hệ điều hành</th>
