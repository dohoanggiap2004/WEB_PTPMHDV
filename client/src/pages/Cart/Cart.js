...
const Cart = () => {
  ...
  return (
    <>
      <Layout>
        <div className="container mx-auto mt-28 rounded-xl shadow-md -mb-4">
          <div className="sm:flex shadow-md my-10">
            ...
            <div
              id="summary"
              className="w-full sm:w-1/4 md:w-1/2 px-8 py-10 bg-gray-200"
            >
                  ...
                  <div className="w-full max-w-3xl mx-auto p-8">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="mt-4">
                        ...
                        <select
                          className="block w-sm text-sm font-medium transition duration-75 border border-gray-800 rounded-lg shadow-sm h-9 focus:border-blue-600 focus:ring-1 focus:ring-inset focus:ring-blue-600 bg-none"
                          name="province"
